var configurationAPI = {
    ...
    submitQuickConfigurationType: function (application, key, value, callback) {
        $.ajax({
            type: "POST",
            url: "../Configuration/SetQuickConfiguration",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: JSON.stringify({
                application: application,
    ...
    InitializeApplicationDropdown: function (callback) {
        $.ajax({
            type: "POST",
            url: "../Configuration/GetApplications",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
                typeof callback === "function" && callback(data);
